...
import FoodMenu from '../../Data/foodData.js'
...
export default function Hero(){
    return(
        <div>
            ...
            <div className='relative'>
                ...
                <div className='absolute inset-0 text-[#ffffff] bg-black/50 font-[Inter]'>
                    <div className='mt-45 ml-10'>
                        <div className='text-[40px] flex flex-col font-[700] '>
                            <span>The Heart of Nigerian Home</span>
                            <span>Cooking</span>
                        </div>
                        <p className='font-[700] text-[20px] my-6'>Handcrafted with passion, delivered with care.</p>
                        <button 
            ...
            <div className='font-[600] flex flex-col bg-[#F3F4F6] justify-center items-center'>
            ...
            {/* <div className='font-[600] flex flex-col justify-center items-center'>
                <p className='text-black mt-40 font-[32px]'>Chef's Specials</p>    F
                <div>
                    {FoodMenu.map((food)=>(
                        <div key={food.id} className='mt-[30px]'>
                            <img src={food.image} alt={food.name} />
                            <h3 className='flex justify-center items-center mt-8'>{food.name}</h3>
                            <p>{food.details}</p>
                            <p>{food.price}</p>
            ...
            <div className='relative'>
                ...
                <div className='absolute inset-0 text-[#ffffff] bg-black/50'>
                    <div className='flex flex-col mt-45 ml-10 font-[Inter]'>
                        <span className='font-[800] text-[43px]'>Introducing Our New Additions!</span>
                        <span className='text-[20px] font-[600] my-4'> Explore exciting new dishes, crafted with the freshest
